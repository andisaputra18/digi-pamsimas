...
<html lang="en" class="light-style layout-wide customizer-hide" dir="ltr" data-theme="theme-default" data-template="vertical-menu-template-free">
  <head>
    ...
    <title>digiPamsimas - Login</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bold">digiPamsimas</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <p class="text-center">
                <span>created by <span class="text-primary">Orbit Indonesia Persada</span></span>
              </p>
            </div>
          </div>
          <!-- /Register -->
